...
public interface FSConnectionProvider {
     ...
     * @param timeoutInMillis timeout of the connection in milliseconds
     * @return a file system connection
     * @throws IOException
     */
    public FSConnection getConnection(final URI uri, final long timeoutInMillis) throws IOException;
}
