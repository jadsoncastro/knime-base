 ...
 */
public class DialogComponentReaderFileChooser extends DialogComponent {
     ...
     */
    public DialogComponentReaderFileChooser(final AbstractSettingsModelFileChooser model, final String historyID,
    ...
    private void triggerSwingWorker() {
        ...
        try {
            ...
            NodeLogger.getLogger(DialogComponentReaderFileChooser.class)
