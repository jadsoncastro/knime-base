...
//            MultiColumnStringManipulationSettings.REPLACE_ACTION});
     ...
     */
    protected Joiner3NodeDialog(final boolean ignore) {
    ...
    protected JPanel createJoinPredicateUIControls(final boolean includeRowId, final boolean showMatchModes) {
        ...
        m_columnPairs.setRowKeyIdentifier(Joiner3Settings.ROW_KEY_IDENTIFIER);
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings,
        ...
        m_matchAllButton.setSelected(m_settings.getCompositionMode().equals(
                    Joiner3Settings.CompositionMode.MatchAll));

        m_matchAnyButton.setSelected(m_settings.getCompositionMode().equals(
                    Joiner3Settings.CompositionMode.MatchAny));
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings)
        ...
        for (int i = 0; i < lr.length; i++) {
            ...
            if (lr[i] instanceof String) {
                ls[i] = Joiner3Settings.ROW_KEY_IDENTIFIER;
            } else {
        ...
        for (int i = 0; i < rr.length; i++) {
            ...
            if (rr[i] instanceof String) {
                rs[i] = Joiner3Settings.ROW_KEY_IDENTIFIER;
            } else {
