...
/**
 * {@link NodeDialog} for the "Create Temp Dir" Node.
 *
...
class CreateTempDir2NodeDialog extends NodeDialogPane {
    ...
    private CreateTempDir2Config m_config;

    public CreateTempDir2NodeDialog(final PortsConfiguration portsConfig, final CreateTempDir2Config config) {
        m_parentDirChooserModel = CreateTempDir2NodeModel.createDirChooserModel(portsConfig);
        final FlowVariableModel writeFvm =
            createFlowVariableModel(m_parentDirChooserModel.getKeysForFSLocation(), FSLocationVariableType.INSTANCE);
        m_parentDirChooserPanel =
            new DialogComponentWriterFileChooser(m_parentDirChooserModel, FILE_HISTORY_ID, writeFvm);
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final PortObjectSpec[] specs)
        ...
        m_tempDirPathVariableNameField.setText(m_config.getTempDirPathVariableName());
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings) throws InvalidSettingsException {
        ...
        m_config.setTempDirPathVariableName(m_tempDirPathVariableNameField.getText());
